...
RobotomyRequestForm :: RobotomyRequestForm() : Form("RobotomyRequestForm", 60, 40) {
    std :: cout << "RobotomyRequestForm: default constructor called" << std :: endl;
}

RobotomyRequestForm ::RobotomyRequestForm(std::string _target) : Form("RobotomyRequestForm", 60, 40), target(_target) {
